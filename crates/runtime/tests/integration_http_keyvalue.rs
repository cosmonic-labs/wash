...
use runtime::{
    ...
    plugin::{http_server::HttpServer, wasi_keyvalue::WasiKeyvalue, wasi_logging::WasiLogging},
};

const HTTP_KEYVALUE_COUNTER_WASM: &[u8] = include_bytes!("../http_keyvalue_counter.wasm");
